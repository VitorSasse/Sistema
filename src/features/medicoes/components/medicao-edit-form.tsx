...
export function MedicaoEditForm(props: {
  ...
  const { editing, servicos, materiais, equipamentos, colaboradores, exigeMaterial, isPending, variant = "section", onChange, onSubmit, onCancel } = props;
  ...
  const formContent = (
    <form onSubmit={onSubmit} className={variant === "modal" ? "medicao-edit-form-modal" : undefined} style={{ display: "grid", gap: 20 }}>
      ...
      <div className="toolbar-actions">
        <button type="button" className="button-ghost" disabled={isPending} onClick={onCancel}>
          Cancelar
        </button>
